...
*An automation script has been supplied for Linux/MacOS (`bootstrap.sh`) and Windows (`bootstrap.ps1`) - these scripts provide a shortcut instead of doing the steps below manually.*
