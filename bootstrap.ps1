...
kubectl apply -f app-of-apps.yml; argocd login --core | out-null; kubectl config set-context --current --namespace=argocd | out-null; argocd app wait app-of-apps | out-null; kubectl config set-context --current --namespace=default | out-null 
